      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{customerOrders.length} đơn hàng</p>
          </div>
        </div>
        <button
...
function OrderTrackingCard({ order }: { order: TrackedOrder }) {
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <div className="text-sm text-gray-500">
                {order.tableNumber ? `Bàn ${order.tableNumber}` : "Mang về"} · {order.customerName ?? "Khách hàng"}
              </div>
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center mb-2">
                ...
                {order.estimatedTime > 0 && (
                  <span className="text-sm font-bold text-amber-600">⏱ ~{order.estimatedTime} phút</span>
                )}
              </div>

...
export const T = {
  ...
  cart_order_type:         { vi: "Hình thức đặt hàng",                                en: "Order type" },
  cart_dine_in:            { vi: "Ăn tại quán",                                       en: "Dine-in" },
  cart_delivery:           { vi: "Giao hàng về nhà",                                  en: "Delivery" },
  ...
  cart_delivery_info:      { vi: "Thông tin giao hàng",                               en: "Delivery Info" },
  cart_delivery_address:   { vi: "Địa chỉ giao hàng *",                              en: "Delivery address *" },
  cart_delivery_address_ph:{ vi: "Số nhà, tên đường, phường/xã, quận/huyện...",      en: "Street address, ward, district..." },
  cart_delivery_phone:     { vi: "Số điện thoại *",                                   en: "Phone number *" },
  cart_delivery_phone_ph:  { vi: "Nhập số điện thoại liên hệ",                       en: "Enter contact phone number" },
  cart_delivery_note:      { vi: "Đơn hàng sẽ được giao trong khoảng 30–45 phút",    en: "Order will be delivered in ~30–45 minutes" },
  ...
  cart_delivery_fee:       { vi: "Phí giao hàng",                                     en: "Delivery fee" },
  ...
  orders_delivery:      { vi: "Giao hàng",                                          en: "Delivery" },
  orders_deliver_to:    { vi: "Giao đến",                                           en: "Deliver to" },
